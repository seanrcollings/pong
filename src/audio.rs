...
pub fn initialize_audio(world: &mut World) {
    let (sound_effects, music) = {
        ...
        sink.set_volume(0.25); // Reduce volume of music
...
pub mod play {
    ...
    pub fn bounce_sound(sounds: &Sounds, storage: &AssetStorage<Source>, output: Option<&Output>) {
    ...
    pub fn score_sound(sounds: &Sounds, storage: &AssetStorage<Source>, output: Option<&Output>) {
        if let Some(ref output) = output.as_ref() {
